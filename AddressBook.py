...
class Load:
    ...
    def load(self, file_name): 
        ...
        if emptyness.st_size != 0:
            ...
            Log().log("Addressbook has been loaded!")
        else:
            Log().log('Adressbook has been created!')
        return data
...
class AddressBook(UserList):
    ...
    def add(self, record):
        ...
        Log().log(f"Contact {record.name} has been added.")

    def save(self, file_name):
        Save().save(file_name, self.data)

    def load(self, file_name):
        self.data = Load().load(file_name)
    ...
    def edit(self, contact_name, parameter, new_value):
        ...
        try:
            ...
            Log().log(f"Contact {contact_name} has been edited!")
            return True
        return False
    ...
    def remove(self, pattern):
        ...
        for account in self.data:
            if account['name'] == pattern:
                ...
                Log().log(f"Contact {account['name']} has been removed!")
                flag = True
